...
{
    /// <summary>
    /// Represents a session-based cache whose behaviour is dependent on the HTTP cache control headers. This class cannot be inherited.
    /// </summary>
    public sealed class HttpCache : Cache
    {
        ...
        /// <summary>
        /// Gets all the currently available caches.
        /// </summary>
