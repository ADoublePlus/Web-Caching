...
namespace WebCaching
{
    ...
    public class RecencyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                if (key == null)
                    ...
                    throw new ArgumentException("An item with the given key doesn't exist in the dictionary.", "key");
                else
                {
                    ret = GetInternal(key);
                }
        ...
        /// <exception cref="System.ArgumentException"><paramref name="capacity">capacity</paramref> is less than or equal to zero.</exception>
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="key">key</paramref> is null.</exception>
        /// <exception cref="System.ArgumentException"><paramref name="key">key</paramref> already exists in the dictionary.</exception>
        public void Add(TKey key, TValue value)
        {
            if (key == null)
                throw new ArgumentNullException("key");
            else if (ContainsKey(key))
                throw new ArgumentException("An item with the given key already exists in the dictionary.", "key");
            else
            {
                SetInternal(key, value);
            }
        ...
        /// <returns>Value indicating whether the dictionary contains an item with the specified key.</returns>
