...
namespace WebCaching
{
    ...
    public class Cache
    {
        ...
        public bool Contains(string key) { return !string.IsNullOrEmpty(key) && ContainsItem(key); }
        ...
        /// <param name="key">Item key.</param>
        /// <returns>Value indicating whether the item with the given key is currently in the cache.</returns>
        protected virtual bool ContainsItem(string key) { return Items.ContainsKey(key); }
    }
}